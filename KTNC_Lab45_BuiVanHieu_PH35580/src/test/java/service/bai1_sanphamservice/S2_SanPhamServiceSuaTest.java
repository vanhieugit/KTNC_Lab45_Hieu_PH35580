...
class S2_SanPhamServiceSuaTest {
    ...
    @Test
    public void test1_SuaSanPham_MaSanPhamNull() {
    ...
    @Test
    public void test4_SuaSanPham_MaSanPhamHopLeNhungThongTinKhacSai() {
